 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("RobertNoScopeM4ST3R42");
		  toPrint += p1.toString("RobertNoScopeM4ST3R42");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("RobertNoScopeM4ST3R42");
		  toPrint += p2.toString("RobertNoScopeM4ST3R42");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("RobertNoScopeM4ST3R42");
		  toPrint += p3.toString("RobertNoScopeM4ST3R42");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("RobertNoScopeM4ST3R42");
                  toPrint += p4.toString("RobertNoScopeM4ST3R42");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("RobertNoScopeM4ST3R42");
                  toPrint += p5.toString("RobertNoScopeM4ST3R42");
